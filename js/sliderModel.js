...
//    }
    ...
    var AbstractSlider = function (config) {
        ...
        // create dom children
        this.view.append('<div class="track"></div><div class="thumb"></div><div class="buffer"></div><div class="played"></div>');
        ...
        this.buffer = this.view.children('.buffer');
...
//        });
        ...
        this.played.css(this.sizeMethodName, this.valueToPosition(this.value)+10);
    };
    ...
    AbstractSlider.prototype.setMax = function (max) {
        this.max = max;
    };
    AbstractSlider.prototype.setBuffer = function (buffered) {
        this.buffered = buffered;
        var bufferedWidth = (buffered * this.trackWidth);
        this.buffer.css(this.sizeMethodName, bufferedWidth);
    };
    AbstractSlider.prototype.setPlayed = function (played) {
        this.played.css(this.sizeMethodName, played);
    };
    ...
    AbstractSlider.prototype.setExternalValue = function (val) {
        if (this.value === val)
            return;
        this.value = val;
        var position = this.valueToPosition(val);
    ...
    AbstractSlider.prototype.onViewMousedown = function (e) {
        if (e.target == this.buffer[0] || e.target == this.track[0] || e.target == this.played[0]) {
...
//    HSlider.prototype = new AbstractSlider();
    ...
    HSlider.prototype.animateThumb = function (position) {
        this.played.animate({width:position+10}, 100);
    ...
    VSlider.prototype.animateThumb = function (position) {
        this.played.animate({height:position+10}, 100);
